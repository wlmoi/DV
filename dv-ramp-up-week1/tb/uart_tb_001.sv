...
module uart_tb_001;
    ...
    initial begin
        ...
        $display("TEST FAIL: UART-001 (timeout)");
        $finish;
    end

    initial begin
        $display("Running test: UART-001");
        $dumpfile("waves/uart_001.vcd");
        $dumpvars(0, uart_tb_001);
    end
    ...
    initial begin
        ...
        if (error_count == 0) begin
            $display("TEST PASS: UART-001");
        end else begin
            $display("TEST FAIL: UART-001 (%0d errors)", error_count);
        end
        $finish;
    end
